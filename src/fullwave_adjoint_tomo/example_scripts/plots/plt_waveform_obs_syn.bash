...
eof
    ...
    gmt pssac $fwddir/*BX${comp}.obs.sac.T005_T050 -J -R  -Ektb -M0.5 -W0.5p -K -O >>$out 
    gmt pssac $fwddir/*BX${comp}.syn.sac.T005_T050 -J -R  -Ektb -M0.5 -W0.5p,red -K -O >>$out 
