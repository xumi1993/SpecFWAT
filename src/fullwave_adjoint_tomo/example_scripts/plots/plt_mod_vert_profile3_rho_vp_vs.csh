...
set PS = fig_profile_${mod}_${eid}_${stnmp}.ps
...
#!
#mv svel13.cpt $CPT
#makecpt -Csvel13.cpt -T2.4/3.3/0.02 -D >$CPT
#makecpt -Csvel13.cpt -T5.2/8.2/0.02 -D >$CPT1
#makecpt -Csvel13.cpt -T3.0/4.2/0.02 -D >$CPT2
#makecpt -Cdrywet -T2.6/3.6/0.02 -D >$CPT
#makecpt -Cdrywet -T5.0/8.9/0.02 -D >$CPT1
#makecpt -Cdrywet -T3.0/5.0/0.02 -D >$CPT2
makecpt -Cjet -I -T2.6/3.5/0.069 -D >$CPT
makecpt -Cjet -I -T5.6/8.6/0.23 -D >$CPT1
makecpt -Cjet -I -T3.3/4.8/0.115 -D >$CPT2
...
#psclip -J -R -C -O -K >>$PS
psscale -D3.4i/0.8i/1.3i/0.5 -C$CPT -Ba0.4f0.2/:"Rho (g/cm@+3@+)": -V -E -O -K -N >> $PS
...
#grdcontour slice.grd.3 -W1p,black -C0.05 -L3.0/4.7 -A+g+o+f1+p1+s8+N -S -R -J -O -K >> $PS
#psclip -J -R -C -O -K >>$PS
psscale -D3.4i/0.8i/1.3i/0.5 -C$CPT1 -Ba0.5/:"Vp (km/s)": -V -E -O -K -N >> $PS
#grdcontour slice.grd -J -R -O -K -Ccont.d -W1/255 >> $PS 
### plot moho
#cat moho.dat |psxy -J -R -W1p -O -K >> $PS
#pstext -R -J -O -K -N -P <<EOF>>$PS
...
#psclip -J -R -C -O -K >>$PS
psscale -D3.4i/0.8i/1.3i/0.5 -C$CPT2 -Ba0.4f0.2/:"Vs (km/s)": -V -E -O -K -N >> $PS
#grdcontour slice.grd -J -R -O -K -Ccont.d -W1/255 >> $PS 
### plot moho
#cat moho.dat |psxy -J -R -W1p -O -K >> $PS
#pstext -R -J -O -K -N -P <<EOF>>$PS
