...
#for evtdir in `cat $indir/final_events_P_TO2013-2015.lst |sed -n '37p'`;do
...
#for evtdir in `cat $indir/final_events_P_XE2005-2007.lst`;do
  ...
  cd $outdir/$ievt
  sac2pkl.py *BHZ.sac -s -o sac.BHZ.pkl
  #sac2pkl.py *BHR.sac -s -o sac.BHR.pkl
  ...
  while read line;do
    ...
    ispick=`grep $stnm $outdir/$ievt/*.BH${comp}.mcp`
    if [ -n "$ispick" ];then
