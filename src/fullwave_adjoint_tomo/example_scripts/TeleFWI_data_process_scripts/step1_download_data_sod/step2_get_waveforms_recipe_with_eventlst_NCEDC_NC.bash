...
for line in `cat $evtlst`;do
   ...
   cd evt_catalog_directP 
   find_events -d36/-120/30/180 -b ${year}-${month}-${day}-${hr} -e ${year}-${month}-${day}-${hr1} -m 5.5  -D0-1000 -r |
   find_stations -R-122.2/-117.5/35.0/38. -n NC -r >recipe_${year}${month}${day}${hr}.xml #### add more stations in the northeastern part 
