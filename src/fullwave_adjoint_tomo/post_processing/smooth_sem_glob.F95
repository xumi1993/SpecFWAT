    ...
    if (USE_GPU) then
      ...
      do ispec = 1, NSPEC_AB
        ...
        do ispec2 = 1, NSPEC_N
          ...
          ! (squared distances)
          call get_distance_vec_glob(dist_h,dist_v,center_x0,center_y0,center_z0,center_x,center_y,center_z)
          ...
          DO_LOOP_IJK
            ...
            call smoothing_weights_vec_glob(x0,y0,z0,sigma_h2_inv,sigma_v2_inv,exp_val, &
