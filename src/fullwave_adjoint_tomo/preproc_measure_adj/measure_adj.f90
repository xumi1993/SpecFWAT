...
subroutine measure_adj()
  ...
  subroutine meas_adj_conv_diff(datr, datz, synr, synz, tstart, tend, npts, net,sta,&
    ...
    conv_diff = conv_diff(nc(1): nc(1)+npts-1)
    conv1 = conv1(nc(1): nc(1)+npts-1)
    conv2 = conv2(nc(1): nc(1)+npts-1)
  ...
  subroutine rotate_adj_src
    ...
    double precision, dimension(NDIM) :: zdata, rdata, tdata, edata, ndata
