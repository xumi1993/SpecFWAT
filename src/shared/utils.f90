...
!=====================================================================
module utils
  use constants, only: CUSTOM_REAL, CUSTOM_DOUBLE, rad2deg, deg2rad, r_earth_km, km2deg, &
                       MAX_NAME_LEN
  implicit none

  integer, public, parameter :: IPRE = 4
  integer, public, parameter :: RPRE = CUSTOM_REAL
  integer, public, parameter :: DPRE = CUSTOM_DOUBLE
