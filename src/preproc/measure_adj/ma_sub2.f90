...
!------------------------------------------------------------------
  subroutine fft_ma(n,xi,zzign,dt)
! Fourier transform
...
!------------------------------------------------------------------
      complex(kind=8), dimension(*) :: xi
      integer :: n
      double precision :: dt

      double precision, parameter :: PI = 3.141592653589793d+00
      complex(kind=8) :: wk, hold, q
  ...
  end subroutine fft_ma

!------------------------------------------------------------------
  subroutine fftinv_ma(npow,s,zzign,dt,r)
...
!------------------------------------------------------------------
      ...
      zign=zzign
      call fft_ma(npow,s,zign,dt)    ! Fourier transform

      do i = 1,nsmp
        r(i) = real(s(i))     ! REAL part
      enddo

  end subroutine fftinv_ma
