...
!----
  ...
  subroutine locate_source_fwat(ievt)
  ...
  call read_source_locations_fwat(fpar%acqui%src_solution_file(ievt), lat,lon,depth,moment_tensor)
...
! #endif
  ...
  end subroutine locate_source_fwat

!
!-------------------------------------------------------------------------------------------------
!

  subroutine read_source_locations_fwat(SOURCE_FILE,lat,lon,depth,moment_tensor)
  ...
  end subroutine read_source_locations_fwat
